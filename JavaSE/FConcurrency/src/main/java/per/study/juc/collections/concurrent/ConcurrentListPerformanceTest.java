...
public class ConcurrentListPerformanceTest
{
    ...
    private final static Map<String, List<Entry>> summary = new HashMap<String, List<Entry>>();
    ...
    private static void pressureTest(final Collection<String> list, int threshold) throws InterruptedException {
        System.out.println(
                "Start pressure testing the Collection [" + list.getClass() + "] user the threshold [" + threshold + "]");
        ...
        System.out.println("for the Collection [" + list.getClass() + "] the average time is " + totalTime / 5);
    }
